...
## pixels wide that one rolled on die will be
@export var rectangle_size_factor : int = 20

## max size of room in pixels (5,5 then 6,6 is max sized room that can be rolled)
@export var rectangle_max_size : int = rectangle_size_factor * 11
